...
#define MOSI             12  // Wire this to the SDI pin
#define MISO             13  // Wire this to the SDO pin
#define SCK              14  // Wire this to the CK pin
#define dSPIN_RESET      11  // Wire this to the STBY line
